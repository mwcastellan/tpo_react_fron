        ...
        <div class="main-principal">
          <div class="contenido-principal">
            <section class="seccion-principal">
              <img class="img-carrusel1" src={carrusel1} alt="Veterinaria" />
            </section>
          </div>
          ...
          <aside class="contenido-aside">
            <article>
              ...
              <p>
                Nuestra misión es brindar atención veterinaria de excelencia a
                las mascotas de nuestra comunidad, promoviendo su salud y
                bienestar a través de servicios preventivos, curativos y de
                educación.
              </p>
              <h3>Nuestra Visión</h3>
              <p>
                Aspiramos a ser la clínica veterinaria líder en nuestra
                comunidad, reconocida por la excelencia en nuestros servicios,
                el compromiso con el bienestar animal y la construcción de
